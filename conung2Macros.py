...
def heal_macro(): #Быстрое применение лечения через контекстное меню
...
def load_macro(): #Быстрая загрызка из топа списка сохранений
...
def double_click(x, y): #Двойной клик при прокрутке коллесика мыши вверх
